...
header .logo {
	font-size: 1.5em; /* Increased size for the logo */
	font-weight: bold;
}
...
<body>
	...
	<div class="container">
		...
		<ul>
			...
			<li><a href="${pageContext.request.contextPath}/orders/cart"><strong>Cart</strong></a></li>
			<li><a
				href="${pageContext.request.contextPath}/subscription/subcart"><strong>SubCart</strong></a></li>
			<li><a href="${pageContext.request.contextPath}/wallets/wallet"><strong>Wallet</strong></a></li>
			<li><a href="${pageContext.request.contextPath}/payment/history"><strong>Payments</strong></a></li>
			<li><a
				href="${pageContext.request.contextPath}/subscription/subscriptionlist"><strong>Subscriptions</strong></a></li>
