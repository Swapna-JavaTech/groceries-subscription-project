...
body {
    ...
    background-image: url('https://wallpaperaccess.com/full/1353554.png'); /* Replace with your image URL */
...
.table-wrapper {
    width: 60%; /* Reduced width of the table wrapper */
...
.table thead th {
    background-color: #6c757d; /* New header color */
    color: #fff;
}
...
.btn-add {
    margin-top: 1rem;
    background-color: rgba(56, 51, 37, 0.8); /* Updated button color */
    color: #fff;
...
<body>
	...
	<div class="container">
		<div class="table-wrapper">
			<h1 class="mb-4 text-center">List of Categories</h1>
			...
			<a href="${pageContext.request.contextPath}/categories/add"
				class="btn btn-add ">Add New Category</a>
		</div>
	</div>
	...
	<script
		...
		integrity="sha384-UOa0XWkDXhiyx5ZqC6Ww8i1Zz7E7p5X5M6E4zP2A8iJ+P1L7Zn6j5aOzFj5K5I"
		crossorigin="anonymous"></script>
	<script
