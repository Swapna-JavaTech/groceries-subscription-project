...
<body>
    ...
    <div class="container mt-4">
        <div class="card">
            ...
            <div class="card-body">
                <form action="${pageContext.request.contextPath}/groceries/add" method="post" enctype="multipart/form-data" id="groceryForm">
                    <div class="form-group">
                        <label for="groceryName">Grocery Name:</label>
                        <input type="text" id="groceryName" name="groceryName" class="form-control" placeholder="Grocery Name" required/>
                        <div class="invalid-feedback">Name must be between 3 and 50 characters and contain no numbers.</div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="grocery_price" name="grocery_price" class="form-control" placeholder="Price" step="0.01" required/>
                        <div class="invalid-feedback">Price must be a positive number.</div>
                    </div>
                    <div class="form-group">
                        <label for="in_stock">In Stock:</label>
                        <input type="number" id="in_stock" name="in_stock" class="form-control" placeholder="In Stock" required/>
                        <div class="invalid-feedback">Stock quantity must be a positive integer.</div>
                    </div>
                    <div class="form-group">
                        <label for="imageURL">Image:</label>
                        <input type="file" id="imageURL" name="imageURL" class="form-control-file" required/>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-secondary">Add Grocery</button>
                </form>
            </div>
        </div>
    </div>
